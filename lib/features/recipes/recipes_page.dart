...
/// O "Rece**y**tas" grande do cabeçalho — o wordmark da marca. Easter egg:
/// 5 toques em menos de 1,5s disparam um estouro (escala + giro que decai) e
/// o "y" ganha, por um instante, a textura do azulejo `arco` (o mesmo módulo
/// já usado na peça decorativa do canto deste cabeçalho, §9.4) em vez da cor
/// chapada — sem bloco de fundo, sem cor alheia à paleta, só o próprio
/// padrão do app vazando pela letra e voltando ao coral sólido no final.
class _ReceytasWordmark extends StatefulWidget {
  const _ReceytasWordmark();

  @override
  State<_ReceytasWordmark> createState() => _ReceytasWordmarkState();
}

class _ReceytasWordmarkState extends State<_ReceytasWordmark>
